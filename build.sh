...
if [ "$HEADER_VERSION" = "2" ]; then
    ...
    MKBOOTIMG_ARGS="--kernel u-boot-nodtb.bin.gz --dtb dts/upstream/src/arm64/$DEVICE_TREE.dtb --pagesize 4096 --base 0x0 --kernel_offset 0x8000 --header_version 2 -o u-boot.img"
else
